...
export async function generatePdf(scenarioId: string, options: PdfOptions) {
  ...
  doc.setFont("helvetica", "bold")
  doc.setFontSize(22)
  doc.text(t("reportTitle"), pageCenter, 78, { align: "center" })

  // Subtitle
  setBlue()
  doc.setFont("helvetica", "normal")
  doc.setFontSize(13)
  doc.text(t("coverSubtitle"), pageCenter, 89, { align: "center" })
  ...
  let metaStartY = scenarioBlockY + scenarioLines.length * 8 + 8
  ...
  // --- High-Presence Executive Metadata Card (Centered) ---
  const metaCardW = 135
  ...
  try {
    ...
    doc.setFont("helvetica", "bold")
    doc.setFontSize(32)
    doc.text("TAKT STUDIO", bpCenter, 95, { align: "center" })
  }
  ...
  doc.setFont("helvetica", "normal")
  doc.setFontSize(10)
  doc.text(t("backpageGenerated"), bpCenter, 118, { align: "center" })
